    ...
    tabPanel("Data analysis", 
             ...
             sidebarLayout(
               sidebarPanel(
                 ...
                 radioButtons(inputId = "exp", label = strong("1. Upload disease-related RNA expression datasets, as the gold standard:"),
                              c("Sample_file",
                                "Tarca_datasets",
                                "Browse")),
               ...
               mainPanel(
                 tabsetPanel(type = "tab",
                             ...
                             tabPanel(h3("Comparison Plots"),
                                      ...
                                      tags$img(src="image/plot.png", align="center",
